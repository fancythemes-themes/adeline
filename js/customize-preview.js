...
( function( $ ) {
	...
	var style = $( '#adeline-color-scheme-css' );
	var api = wp.customize;

	if ( ! style.length ) {
		style = $( 'head' ).append( '<style type="text/css" id="adeline-color-scheme-css" />' )
		                    .find( '#adeline-color-scheme-css' );
	}
	...
	function writeCSS(){
		...
		$('#adeline-preview-style-inline-css').text(cssOutput);
	}
