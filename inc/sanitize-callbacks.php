 ...
 */
function adeline_sanitize_layout($value) {
 ...
 */
function adeline_sanitize_color_field($value) {
	return $value;
}
 ...
 * @return HTML string sanitized with wpkses.
 */
function adeline_sanitize_blog_list_view($value) {
 ...
 * @return HTML string sanitized with wpkses.
 */
function adeline_sanitize_footer_credit($value) {
	$allowed_tags = array(
						'a' => array(
							'href' => array(),
							'title' => array(),
 ...
 */
function adeline_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function adeline_sanitize_number_absint( $number, $setting ) {
 ...
 */
function adeline_sanitize_image( $image, $setting ) {
	/*
